...
module.exports = {
  async up(queryInterface) {
    const socialMediaAccounts = [
      { url: "https://www.instagram.com/atakumbelediyesi", platform: "Instagram" },
      { url: "https://x.com/atakumbelediye", platform: "X" },
      { url: "https://www.youtube.com/@atakumbelediyesi", platform: "YouTube" },
      { url: "https://www.facebook.com/atakumbelediyesi", platform: "Facebook" },
    ];
    ...
    const politicalCareer = [
      ...
      },
      {
        ...
        period: "2015-2019",
        description:
          "Atakum ilçe teşkilatı yönetim kurulunda görev üstlenerek yerel siyasette etkin rol oynadı. 38. Olağan Kongre'de ilçe başkanlığı seçimine katıldı.",
        institution: "CHP Atakum İlçe Teşkilatı",
      },
      {
    ...
    await queryInterface.bulkInsert("Presidents", [
      {
        ...
        biography:
          "1983 yılında Almanya'da dünyaya gelen Serhat Türkel, 1 yaşında ailesiyle birlikte Samsun'un Atakum ilçesine yerleşti. İlk, orta ve lise eğitimini Atakum'da tamamlayan Türkel, ardından Ondokuz Mayıs Üniversitesi İktisadi ve İdari Bilimler Fakültesi'nden mezun oldu. 2008 yılında siyasi yaşamına CHP'nin gençlik kollarında başlayan Türkel, 2015–2019 yılları arasında CHP Atakum İlçe Yönetim Kurulu Üyesi olarak görev yaptı. 2009 yılında reklam sektörüne adım atan Türkel, 2014 yılında ise otelcilik alanında girişimci oldu. 31 Mart 2024 yerel seçimlerinde Atakum Belediye Başkanı seçilen Serhat Türkel, evli ve iki çocuk babasıdır.",
        message:
        ...
        social_media_accounts: JSON.stringify(socialMediaAccounts),
        birth_place: "Almanya",
        birth_year: 1983,
        grown_place: "Atakum / Samsun",
        marital_status: "Evli",
        education: JSON.stringify(education),
        political_career: JSON.stringify(politicalCareer),
        work_life: JSON.stringify(workLife),
      },
    ]);
  },
