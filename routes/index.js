...
const atakumWebsiteRoutes = require("./atakumWebsiteRoutes");
...
const keosMapRoutes = require("./keosMapRoutes");
const heroVideoRoutes = require("./heroVideoRoutes");
const mobileAppRoutes = require("./mobileAppRoutes");
const marketplaceRoutes = require("./marketplaceRoutes");
const muhtarRoutes = require("./muhtarRoutes");
...
router.use("/atakum-websites", atakumWebsiteRoutes);
...
router.use("/keos-map", keosMapRoutes);
router.use("/hero-video", heroVideoRoutes);
router.use("/mobile-app", mobileAppRoutes);
router.use("/marketplaces", marketplaceRoutes);
router.use("/muhtars", muhtarRoutes);
